...
```{r DATA IMPORT NINA, eval = TRUE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r DATA IMPORT HINN, eval = FALSE, echo = FALSE, message = FALSE}
...
```{r RODENTS TIMESERIES HINN, eval = FALSE, echo = FALSE}  
